...
cmdhandler.o: cmdhandler.cpp cmdhandler.h handler.h searcheng.h
	$(CXX) $(CXXFLAGS) $(DEFS) -c -o $@ cmdhandler.cpp
searcheng.o: searcheng.cpp searcheng.h pageparser.h webpage.h
	$(CXX) $(CXXFLAGS) $(DEFS) -c -o $@ searcheng.cpp
combiners.o: combiners.cpp combiners.h searcheng.h
...
search-shell: $(OBJS)
	$(CXX) $(CXXFLAGS) $(DEFS) -o search-shell $(OBJS)
